...
STRIPE_MODE = config('STRIPE_MODE', default='test')  # 'test' or 'live'
...
STRIPE_SECRET_KEY = STRIPE_KEYS[STRIPE_MODE]["SECRET_KEY"]
STRIPE_PUBLISHABLE_KEY = STRIPE_KEYS[STRIPE_MODE]["PUBLISHABLE_KEY"]
STRIPE_WEBHOOK_SECRET = STRIPE_KEYS[STRIPE_MODE]["WEBHOOK_SECRET"]

# Optional (test only)
STRIPE_TEST_CLOCK_ID = config('STRIPE_TEST_CLOCK_ID', default=None)

STRIPE_LIVE_MODE = STRIPE_MODE == "live"
ALLOW_STRIPE_LIVE_MUTATION = config('ALLOW_STRIPE_LIVE_MUTATION', default=False, cast=bool)
